...
export default function Article3() {
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', p: 3 }}>
      ...
      >
        Manage Your Paylocity Profile: What You Can Update
      </Typography>
      <Typography
        variant="body1"
        sx={{ fontSize: '1rem', color: 'text.secondary', mb: 2 }}
      >
        Paylocity’s Employee Self-Service portal lets you update your personal information, tax settings, payment preferences, benefits, and more, all from the web or mobile app. Download the app to manage your profile on the go:
      </Typography>
